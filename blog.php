        ...
        <section id="blog-container" class="container pt-5">
            <div class="row">
                <div class="post col-lg-6 col-md-6 col-12 pb-5">
                    ...
                    <h3 class="text-center font-weight-normal pt-3">The best way to change your summer wardrobe into autmun wardrobe</h3>
                ...
                <div class="post col-lg-4 col-md-6 col-12 pb-5">
                    ...
                    <h4 class="font-weight-normal pt-3">The best way to change your summer wardrobe into autmun wardrobe</h4>
                </div>
                <div class="post col-lg-4 col-md-6 col-12 pb-5">
                    <div class="post-img">
                        <img class="img-fluid w-100" src="img/blog/4.jpg" alt="">
