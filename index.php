    ...
    <body>
        ...
        <section id="home">
          <div class="container">
            ...
            <p>Description for the heading that is stated<br>after the line break</p>
        ...
        <section id="new" class="w-100">
          <div class="row p-0 m-0">
            <div class="one col-lg-4 col-m-12 col-12 p-0">
              <img class="image-fluid" src="img/new/1.jpg" alt="">
              <div class="details">
                <h2>80 Hazaar ke shoes</h2>
        ...
        <section id="featured" class="my-5 pb-5">
          ...
          <div class="row mx-auto container-fluid">
            <div class="product text-center col-lg-3 col-md-4 col-12">
              ...
              <div class="star">
                <i class="bi bi-star"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
        ...
        <section id="banner" class="my-5 pb-5">
          <div class="container">
            <h4>SALE SPECIAL</h4>
            <h1>Festive Collection<br>UPTO 20% OFF</h1>
            <button class="text-uppercase">Shop Now</button>
